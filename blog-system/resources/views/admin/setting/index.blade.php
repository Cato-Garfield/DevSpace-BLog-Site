    ...
    <div class="row mt-3">
        ...
        @endif
            ...
            <div class="card-header">
                <h4><i class="fa fa-gear"></i>Website Setting</h4>
                </div>
                <div class="card-body">
                ...
                <form action="{{ url('admin/settings') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if ($setting)
                            <img src="{{ asset('uploads/settings/'.$setting->logo) }}" width="70px" height="70px" healt="Logo">
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if ($setting)
                            <img src="{{ asset('uploads/settings/'.$setting->favicon) }}" width="70px" height="70px" healt="Logo">
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="meta_keyword" class="form-control" rows="3">
                            @if($setting) {{ $setting->meta_keyword }} @endif
                        </textarea>
                    </div>
